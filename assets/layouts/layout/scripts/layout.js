...
var Layout = function () {
    ...
    var handleSidebarToggler = function () {       
        ...
        */
        $('body').on('click', '.logo-default', function (e) {
            var divapplauncher = $(".div-app-launcher");
            //
            var displayProp = divapplauncher.css("display");
            var display = "none";
            if (!divapplauncher.visible(false)) {
                display = "inline";
            }
            divapplauncher.css("display", display);
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                $(".div-titulo-portal").css("display", "inline");
            } else {
                body.addClass("page-sidebar-closed");
                ...
                $(".div-titulo-portal").css("display", "none");
            }
